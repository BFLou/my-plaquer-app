...
export const getAuthErrorMessage = (error: any, email?: string): AuthErrorInfo => {
  ...
  switch (errorCode) {
    ...
    case 'auth/requires-recent-login':
      return {
        message: 'For security reasons, please sign out and sign in again before making this change.',
...
export const getSpecificErrorMessage = (error: any, context: 'signin' | 'signup' | 'reset' = 'signin'): string => {
