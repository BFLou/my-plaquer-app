...
export const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      <Route
        path="/join/to-create-collections"
        element={
          <AuthGate
