  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Explore London's blue plaques on our interactive map with filtering by historical period, profession, and location.",
      color: 'blue',
      isComingSoon: false,
    },
    {
      ...
      description:
        'Check in at plaques you visit and build your personal collection of historical discoveries.',
      color: 'green',
      isComingSoon: false,
    },
    {
      ...
      title: 'Custom Routes',
      description:
        'Create walking routes connecting multiple plaques to discover history at your own pace.',
      color: 'amber',
      isComingSoon: false,
    },
    {
      ...
      description:
        'Learn about the historical significance of each plaque with detailed information and related stories.',
      color: 'purple',
      isComingSoon: false,
    },
    {
      ...
      title: 'Share & Collect',
      description:
        'Create themed collections and share your discoveries with friends and other history enthusiasts.',
      color: 'pink',
      isComingSoon: true,
    },
    {
      ...
      title: 'Community',
      description:
        'Join a community of history explorers, share photos, and contribute to our growing database.',
      color: 'indigo',
      isComingSoon: true,
    },
  ];
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-700 text-white py-8 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          <p className="opacity-90 mt-1">
            Discover and explore London's rich history through its iconic blue
            plaques marking historical locations.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2 order-2 md:order-1">
              ...
              <p className="text-gray-700 mb-4">
                Plaquer was created with a simple mission: to connect people
                with the rich history that surrounds them in their daily lives.
                London's blue plaques mark the homes and workplaces of
                significant historical figures, but many of these stories remain
                hidden in plain sight.
              </p>
              <p className="text-gray-700 mb-6">
                We believe that history becomes more meaningful when it's
                personal. By helping you discover, track, and share these
                historical markers, we hope to make London's past come alive in
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              Discover, track, and share London's historical markers with our
              intuitive features.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row gap-12 items-center">
                  ...
                  <div className="space-y-4">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 ml-6 mt-1">
                        English Heritage official plaques
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 ml-6 mt-1">
                        Westminster City Council plaques
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 ml-6 mt-1">
                        Various commemorative plaques and markers
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                Plaquer's database is powered by Open Plaques, a community-led
                project that catalogues commemorative plaques across the UK and
                beyond. We've enhanced this data with additional information and
                location accuracy.
              </p>
              <p className="text-gray-700 mb-6">
                We also welcome contributions from our community. If you notice
                missing information or have photos of plaques to share, please
                let us know.
              </p>
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <p className="mt-4 max-w-2xl mx-auto opacity-90">
                  Have questions, suggestions, or want to contribute to Plaquer?
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col justify-center">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-4">
                    ...
                    <p className="mb-4">
                      Prefer to use your own email client? Feel free to reach
                      out to us directly.
                    </p>
                    <Button
        ...
        <section className="py-16 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of history enthusiasts discovering London's rich
            heritage one plaque at a time.
          </p>
