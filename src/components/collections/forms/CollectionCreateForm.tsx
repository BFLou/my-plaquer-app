        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                {colors.map((color) => (
                  ...
                  >
                    <div
                      className={`w-full h-12 rounded-lg ${color.value} cursor-pointer ${
                    ...
                    ></div>
                    <span
                      className={`absolute inset-0 flex items-center justify-center text-sm font-medium ${color.textColor}`}
                    >
                      {color.name}
                    </span>
                  </div>
            ...
            <div className="rounded-lg bg-gray-50 p-4 mt-4">
              ...
              <div
                className={`p-4 bg-white rounded-lg shadow-sm border ${isLoading ? 'opacity-70' : ''}`}
              >
                <div className="flex gap-4 items-start">
                  <div
                    className={`w-16 h-16 rounded-lg flex items-center justify-center text-white text-3xl ${formState.color}`}
                  >
                    {formState.icon}
                  </div>
