        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              ...
              {collections.length !== 1 ? 's' : ''} created
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          {recentCollections.map((collection) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center text-white text-lg sm:text-xl ${collection.color} flex-shrink-0`}
                >
                  {collection.icon}
                </div>
