    ...
    <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-500 truncate">
              ...
              {totalDistance > 0 && (
                <span className="hidden sm:inline"> • {totalDistance.toFixed(1)} km total</span>
              )}
            </p>
      ...
      {routes.length === 0 ? (
        <div className="text-center py-8 sm:py-12 bg-gray-50 rounded-lg">
          ...
          <h3 className="text-base sm:text-lg font-medium text-gray-700 mb-2">No Routes Yet</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-500 mb-2">
                      ...
                      <div className="flex items-center gap-1">
                        <Clock size={12} />
                        <span>~{Math.ceil((route.total_distance || 0) * 12)} min</span>
                      </div>
                    </div>
