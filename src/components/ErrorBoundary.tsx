...
> {
  ...
  render() {
    if (this.state.hasError) {
      const isRenderLoop = this.state.error?.message.includes(
        'Too many re-renders'
      );
          ...
          <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
              <div className="text-orange-500 mb-4">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.944-.833-2.714 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"
                  />
                </svg>
              </div>
              ...
              <p className="text-gray-600 mb-4">
                The app encountered a render loop. Auto-recovery is in
                progress...
              </p>
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">
              There was an issue loading the map. Please refresh the page or try
              again later.
            </p>
            <button
              onClick={() => window.location.reload()}
