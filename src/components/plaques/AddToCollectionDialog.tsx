      ...
      <div className="space-y-4">
        ...
        {loading ? (
          <div className="py-12 text-center">
            ...
            <p className="mt-4 text-base text-gray-500">Loading collections...</p>
          </div>
        ) : filteredCollections.length === 0 ? (
          <div className="py-12 text-center">
            <FolderOpen className="mx-auto h-12 w-12 text-gray-400 mb-4" />
            <p className="text-base text-gray-500 mb-2">No collections found</p>
            <p className="text-sm text-gray-400">Create a new collection from the Collections page</p>
          </div>
        ) : (
              ...
              {filteredCollections.map(collection => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center text-white text-xl ${collection.color}`}>
                      {collection.icon}
                    </div>
                    
                    {/* Collection Info */}
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-base mb-1">{collection.name}</h4>
