...
const PrivacySettings: React.FC = () => {
  ...
  const privacyOptions = [
    ...
    },
    {
      ...
      description:
        'Help us improve Plaquer by sharing anonymous usage statistics',
      value: analytics,
    ...
    <div>
      <div className="p-6 border-b">
        ...
        <p className="text-gray-500">
          Your data is private by default. Control what you share to help
          improve the app.
        </p>
      </div>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">
                Your collections, visits, and activity are only visible to you
              </p>
            </div>
          </div>
              ...
              <div key={option.id} className="p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 bg-${option.color}-100 rounded-lg flex items-center justify-center`}
                    >
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Optional sharing and community features are planned for future
                updates
              </p>
            </div>
          </div>
