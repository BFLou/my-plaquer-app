...
const AuthGate: React.FC<AuthGateProps> = ({
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    if (formData.password.length < 8) {
      setAuthError({
        code: 'validation/password-too-short',
    ...
    if (!agreeToTerms) {
      setAuthError({
        code: 'validation/terms-required',
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div>
            ...
            <p className="opacity-90 mt-1">
              Create a free account to {finalFeatureName} and start building
              your personal collection of London's historic plaques
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Join thousands of history enthusiasts exploring London's
                heritage with these powerful features.
              </p>
            </div>
