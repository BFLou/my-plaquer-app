...
const EnhancedHowItWorks: React.FC<EnhancedHowItWorksProps> = ({
  onStartJourney,
}) => {
  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Use our interactive map to locate London's iconic blue plaques marking where famous historical figures lived and worked.",
      color: 'blue',
      stats: [
    ...
    },
    {
      ...
      description:
        'Check in at plaque locations, mark them as visited, and optionally add photos to build your personal visited collection.',
      color: 'green',
      stats: [
    ...
    },
    {
      ...
      description:
        'Organize your visited plaques into custom collections based on themes, time periods, or neighborhoods.',
      color: 'purple',
      stats: [
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <div
          className={`text-center mb-12 md:mb-16 transition-all duration-700 transform ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}
        >
          <div className="inline-block bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-sm font-medium mb-4">
            How Plaquer Works
          </div>
          <h2 className="text-2xl md:text-3xl font-bold mb-3">
            Discover London's Historic Plaques
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore thousands of historic plaques across London and create your
                                ...
                                <div className="absolute inset-0 grid grid-cols-5 grid-rows-8">
                                  {Array(40)
                                    ...
                                    .map((_, i) => (
                                      <div
                                        key={i}
                                        className="border border-blue-100/50"
                                      ></div>
                                    ))}
                                </div>
            ...
            <div className="p-8 relative z-10 max-w-xs h-full flex flex-col">
              ...
              <div className="flex gap-4 mb-8">
                {features[activeFeature].stats.map((stat, i) => (
                  <div
                    key={i}
                    className="bg-gray-50 rounded-lg p-3 text-center flex-1"
                  >
                    <div
                      style={{
                        color:
                    ...
                    <div className="w-full h-full bg-white overflow-hidden rounded-lg shadow-sm">
                      ...
                      {index === 1 && (
                        <div className="h-full flex flex-col">
                          <div
                            className="h-10 flex items-center px-3"
                            style={{ backgroundColor: 'rgba(22, 163, 74, 1)' }}
                          >
